	...
	def _init_broker(self):
		...
		try:
			...
			with open(ConfigPath, 'wt') as out:
				config = BridgeSettings.format(identifier, password, VrmBroker, SoftwareVersion, CaBundlePath)
				out.write(config)
